...
const Hero = () => {
    ...
    return (
        <div style={{ backgroundImage: `url(${assets.gradientBackground})` }} className='px-4 sm:px-20 xl:px-32 relative inline-flex flex-col w-full justify-center bg-cover bg-no-repeat min-h-screen'>
            ...
            <div className='flex flex-wrap justify-center gap-4 text-sm max-sm:text-x-5'>
            ...
            <img src={assets.user_group} alt="User Group" className="h-8" /> Trusted by 1L+ people
